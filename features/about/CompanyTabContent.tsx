...
import { ShieldCheck, Target, Award, Building2, Trees, HeartHandshake, CheckCircle2 } from 'lucide-react';
...
const iconMap: Record<string, React.ReactNode> = {
  ShieldCheck: <ShieldCheck className="size-5 text-emerald-700" />,
  Building2: <Building2 className="size-5 text-emerald-700" />,
  Trees: <Trees className="size-5 text-emerald-700" />,
  HeartHandshake: <HeartHandshake className="size-5 text-emerald-700" />,
};
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 items-center">
        <div className="lg:col-span-6 flex flex-col gap-4">
          ...
          <p className="text-slate-600 leading-relaxed text-sm sm:text-base">
            Didirikan pada tahun {companyData.establishedYear}, TRICIPTA LAND berawal dari komitmen teguh untuk menyediakan kawasan hunian yang tidak hanya asri dan berkualitas, melainkan menjamin kepastian hukum sertifikat (SHM) yang telah terpecah per kavling sejak hari pertama unit dipasarkan.
          </p>
          <p className="text-slate-600 leading-relaxed text-sm sm:text-base">
            Dalam kurun waktu lebih dari 8 tahun berkarya, kami telah sukses membangun 8 kawasan perumahan mandiri dengan lebih dari 1.200 unit rumah yang telah diserahterimakan dengan penuh kepuasan kepada keluarga Indonesia.
          </p>
        </div>
      ...
      <div className="flex flex-col gap-8">
        <div className="text-center max-w-2xl mx-auto space-y-2">
          ...
          <h3 className="font-serif text-2xl sm:text-3xl font-bold text-slate-900 tracking-tight">
            Nilai-Nilai Utama TRICIPTA LAND
          </h3>
            ...
            >
              <div>
                <div className="size-11 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center mb-4 group-hover:bg-emerald-50 group-hover:border-emerald-200 transition-colors">
                  {iconMap[val.iconName] || <ShieldCheck className="size-5 text-emerald-700" />}
                </div>
